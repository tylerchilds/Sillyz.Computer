...
CONTENTS
Kinda Programming the Web Platform

ABOUT
Kinda is an educational platform for guardians and their children to be
technically literate and empowered digitally in a kinda pragmatic way.
...
const CACHE_KEY = window.CACHE_KEY || "CACHE_KEY";
  ...
  const context = {
    set: function(schema, payload, handler = defaultHandler) {
      if (typeof handler === 'function') {
        const newCache = touchCache(state[CACHE_KEY], schema);
...
function kinda(selector, initialState = {
}) {
